...
| 维度 | 满分 | 评分标准 |
|------|------|----------|
| completeness（完整性） | 10 | 是否覆盖了问题的全部关键要点：9-10=极其完整；7-8=基本完整；5-6=有遗漏；3-4=遗漏较多；0-2=严重缺失 |
| accuracy（准确性） | 10 | 技术细节是否正确，有无错误：9-10=完全正确；7-8=基本正确，小错；5-6=部分正确；3-4=错误较多；0-2=基本错误 |
...
```json
{
  ...
  "follow_up_suggestion": "<基于候选人的薄弱点，建议下一步追问的具体问题，50字以内>"
}
```"""
